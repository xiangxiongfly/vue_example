...
async function getOrderInfo() {
  const {result} = await getOrderInfoApi();
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <div class="box-body">
          ...
          <a class="my-btn" href="javascript:">双休日、节假日送货：周六至周日</a>
        </div>
        <!-- 支付方式 -->
        ...
        <div class="box-body">
          ...
          <a style="color:#999">货到付款需支付5元手续费</a>
        </div>
        <!-- 金额明细 -->
    ...
    <el-dialog v-model="showDialog" title="切换收货地址" width="30%" center>
      <div class="addressWrapper">
        <div class="text item"
             ...
             v-for="item in orderInfo.userAddresses" :key="item.id"
